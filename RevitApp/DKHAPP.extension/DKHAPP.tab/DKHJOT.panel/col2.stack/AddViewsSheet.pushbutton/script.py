...
title_block_type = get_type_by_name('A0 metric')
        ...
        try:
            ...
            for view in self.selected_views:
                ...
                if type(view) == ViewSchedule:
                    ...
                    # Set the sheet name to match the schedule name
                    sheet.Name = view.Name

                    # Add the schedule to the sheet
                    DB.ScheduleSheetInstance.Create(doc, sheet.Id, view.Id, DB.XYZ(0, 0, 0))
