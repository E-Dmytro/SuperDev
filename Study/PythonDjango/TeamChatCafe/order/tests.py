...
class TestOrderModel(TestCase):
    ...
    def test__str__end_at_is_None(self):
        ...
        order_to_expect = "'id': 101, 'user': CustomUser(id=111), 'menu': Menu(id=101), 'created_at': '2017-04-10 12:00:00+00:00', 'end_at': None, 'plated_end_at': '2017-04-10 12:00:00+00:00'"
    ...
    def test__str__end_at_is_not_None(self):
        ...
        order_to_expect = "'id': 103, 'user': CustomUser(id=111), 'menu': Menu(id=103), 'created_at': '2017-04-10 12:00:00+00:00', 'end_at': '2017-04-25 12:00:00+00:00', 'plated_end_at': '2017-04-10 12:00:00+00:00'"
    ...
    def test_get_by_id_positive(self):
        ...
        self.assertEqual(order.menu, self.book1)
    ...
    def test_delete_by_id_positive(self):
        ...
        self.assertEqual(self.book3, Menu.objects.get(id=103))
    ...
    def test_create_positive(self):
        ...
        with mock.patch('django.utils.timezone.now') as mock_time:
            ...
            self.assertEqual(order.menu, self.book2)
            self.assertEqual(order.created_at, TEST_DATE)
