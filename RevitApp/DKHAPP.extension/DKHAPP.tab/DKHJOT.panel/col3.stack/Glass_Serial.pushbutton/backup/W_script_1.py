...
with Transaction(doc, __title__) as t:
    ...
    for window in windows:
        ...
        if supercomponent is not None:
            ...
            elif name_family == "UW" or name_family == "UWB":
                if glass_symbol=="W":
                    combine = glass_symbol + "-" + str(width) + "-" + str(height) + "-V"
                else:
                    combine = glass_symbol + "-" + str(width) + "-" + str(height) + "-" + glass_type_total

            elif name_family == "UV":
                # if TopGlass == True:
                #     slide_door_top_glass = "X"
                combine = glass_symbol + "-" + str(width)  + glass_bld_output_side

            elif name_family == "UCEXT":
                if glass_symbol == "EXS":
                    combine = glass_symbol + glass_orientation_side + "-" + str(width) + "-" + str(height) + "-" + glass_type_total + angle_type
                else:
                    combine = glass_symbol + "-" + str(width) + "-" + str(height) + "-" + glass_type_total + angle_type
